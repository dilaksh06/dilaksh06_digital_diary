...
def save_file_names_to_json(folder_path, output_file):
    try:
        ...
        files = [f"./assets/images/END_DEC312024/a/{f}" for f in os.listdir(folder_path) if os.path.isfile(os.path.join(folder_path, f))]
...
if __name__ == "__main__":
    folder_path = "C:/xampp/htdocs/dilaksh06_digital_diary/assets/images/END_DEC312024/a" # Replace with your folder path
